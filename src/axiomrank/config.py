...
class RankerConfig:
    ...
    device: str = "cpu"  # hf backend: torch device ("cuda" also selects an AMD GPU under ROCm)
    dtype: str = "float32"  # hf backend: torch dtype; use "bfloat16" for T5 (fp16 overflows)
